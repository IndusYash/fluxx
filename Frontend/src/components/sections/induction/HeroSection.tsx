...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative w-full h-full overflow-hidden">
      {/* Background Threads - Desktop only */}
      ...
      {/* Hero Content */}
      <div
        className="relative z-10 w-full h-full flex items-center justify-center px-6 md:px-12"
        style={{ marginTop: "-1cm" }}
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="text-[#1DB954] font-semibold">innovation</span> and
            <span className="text-[#1DB954] font-semibold"> discovery</span>.
            Where curious minds converge to shape the future through
            cutting-edge research and groundbreaking solutions.
          </p>
