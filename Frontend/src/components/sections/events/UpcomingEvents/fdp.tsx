  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        {/* Event Info Cards (faster entrance & hover) */}
        <motion.div
          initial={{ opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Statistics Highlight (snappier hover) */}
        <motion.div
        ...
        {/* Content Sections (faster reveal) */}
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-lg group-hover:text-gray-200 transition-colors">
              This AICTE Training and Learning (ATAL) Academy sponsored Faculty Development Programme, organized by the Department of Computer Science & Engineering at MMMUT Gorakhpur, offers a comprehensive exploration of mechanistic interpretability, a cutting-edge area of AI research focused on understanding the computational mechanisms and internal representations learned by neural networks.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <li
                  key={index}
                  className="flex items-start gap-3 text-gray-300 p-3 rounded-lg"
                >
            ...
            <ul className="space-y-3">
              {[
                ...
                >
                  ...
                  <span className={`text-base ${item.highlight ? 'font-bold text-yellow-300 bg-yellow-500/10 px-2 py-1 rounded' : ''}`}>
                    {item.text}
                  </span>
                </li>
              ))}
          ...
          {/* Registration Process - MORE FORMAL */}
          <motion.div
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              <motion.span
                className="w-1.5 h-8 bg-gradient-to-b from-gray-400 to-gray-600 rounded-full"
              ></motion.span>
              ...
              {[
                {
                  ...
                  description: 'Access the official AICTE ATAL Academy portal and navigate to the registration page. New users must click on "Sign Up Now" to begin the registration process.'
                },
                {
                  step: '2',
                  title: 'Create Account',
                  description: 'Select your role as "Participant" and complete the registration form with accurate details including full name, institutional email address, contact number, institution name, department, and create a secure password.'
                },
                {
                  step: '3',
                  title: 'Email Verification',
                  description: 'Check your registered email inbox for a verification link sent by ATAL Academy. Click on the verification link to activate your account before proceeding further.'
                },
                {
                  step: '4',
                  title: 'Complete Profile Information',
                  description: 'Log in to your verified account and complete all mandatory fields in your profile including personal information, educational qualifications, professional background, and institutional details.'
                },
                {
                  step: '5',
                  title: 'Programme Registration',
                  description: 'Navigate to the FDP section, select "ATAL Online" as the programme type, choose the appropriate month (January 2026) and mode (Online), then select this specific FDP programme and submit your application.'
                }
              ].map((item, index) => (
                <div
                  key={index}
            ...
            <div className="mt-6 p-4 rounded-lg bg-gray-900/60 border border-gray-700/40">
              <p className="text-gray-300 text-sm leading-relaxed">
                <strong className="text-white">Important Note:</strong> Ensure all information provided is accurate and complete. Certificates of completion will be issued exclusively to participants who have successfully registered through the official ATAL Portal and meet all attendance requirements.
              </p>
            </div>
          </motion.div>


          {/* Registration Button - MORE FORMAL */}
          <motion.div
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
