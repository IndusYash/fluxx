...
export interface BentoProps {
    activities: Activity[]; // Or a specific Activity[] interface
    textAutoHide?: boolean;
    enableStars?: boolean;
...
const MagicBentoEvents: React.FC<BentoProps> = ({
    activities,
    textAutoHide = true,
    enableStars = true,
            ...
            <div className="bento-section grid gap-6 p-3 w-full max-w-[1200px] mx-auto select-none relative" ref={gridRef}>
                <div className="card-recard-responsive grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-items-center">
                    ...
                    {activities.map((activity, index) => {
                        ...
                        if (enableStars) {
                            return (
                                <ParticleCard
                                    ...
                                    style={cardStyle}
                                    disableAnimations={false} // Adjust as needed
                        ...
                        // Fallback card if stars are disabled
                        return (
                            <div
                                key={activity.id}
                                className={baseClassName}
...
export default MagicBentoEvents;
